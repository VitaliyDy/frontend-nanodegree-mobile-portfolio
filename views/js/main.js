...
var resizePizzas = function(size) {
  ...
  //  delete determineDx func - cause it's useless 
  //  var oldSize = oldWidth / windowWidth;
  //  var newSize = sizeSwitcher(size);
  //  dx = (newSize - oldWidth/windowWidth;) * windowWidth ---> dx = newSize* windowWidth - oldWidth
  //  oldWidth = randomPizzaContainers[i].offsetWidth  -->
  //  randomPizzaContainers[i].offsetWidth + (sizeSwitcher(size) * windowWidth -  randomPizzaContainers[i].offsetWidth) ---> 
   // randomPizzaContainers[i].style.width = newSize* windowWidth
    ...
    for (var i = 0; i < randomPizzaContainersLength; i++) {         
      randomPizzaContainers[i].style.width = ( sizeSwitcher(size)* windowWidth) + 'px';
    }
  }
